...
admin_router.post("/doctor", role_check, admin_contoller.add_doctor);
admin_router.delete("/doctor/:id", role_check, admin_contoller.delete_doctor);
admin_router.get("/appointments", role_check, admin_contoller.all_appointments);
